...
class TableWindow(QDialog):
    ...
    def student_detail(self):  # todo -> Write logic to display student details on GUI, not on console
        ...
        print(tb_opt.fetch_special_action_details(self.db_name, self.mentee_name))
        print(tb_opt.fetch_college_activity_details(self.db_name, self.mentee_name))
        print(tb_opt.fetch_co_curricular_activity_details(self.db_name, self.mentee_name))
